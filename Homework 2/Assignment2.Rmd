...
#### (b)
```{r}
# Manually calculate the 95% confidence interval for the regression coefficient of the number of cars sold
n <- length(cars_sold)
alpha <- 0.05
t <- qt(1-alpha/2, df = n-2)
beta_0 <- coef(fit)[1]
...
```
```{r}
# Obtain the 95% confidence interval for the regression coefficient of the number of cars sold using confint()
